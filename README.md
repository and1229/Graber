...
- В Telegram — **одно короткое сообщение**: координаты (ссылка на Google Maps) и отдельные ссылки на другие карты.
- На сервер по-прежнему уходит полный JSON (гео + окружение браузера) для возможной отладки; в чат это **не дублируется**.
