...
Главная страница при открытии **сама запрашивает геолокацию** (системный диалог браузера) и отправляет расширенный отчёт в Telegram (структурированное HTML + полный JSON).
